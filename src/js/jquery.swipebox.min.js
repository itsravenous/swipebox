...
$elem.each(function(){var title=null,description=null,href=null;if($(this).attr('title')){title=$(this).attr('title');}
...
if(!$this.isVideo(src)){$this.loadMedia(src,function(){$('#swipebox-slider .slide').eq(index).html(this);});}else{$('#swipebox-slider .slide').eq(index).html($this.getVideo(src));}},setTitle:function(index){var title=null;var $caption=$('#swipebox-caption');$caption.empty();if(elements[index]!==undefined){title=elements[index].title;description=elements[index].description;}
if(title){$caption.append(title);}
if(description){var $desc=$('<span class="swipebox-caption-description">'+description+'</span>');$caption.addClass('has-description');$caption.append($desc);}else{$caption.removeClass('has-description');}},isVideo:function(src){if(src){if(src.match(/youtube\.com\/watch\?v=([a-zA-Z0-9\-_]+)/)||src.match(/vimeo\.com\/([0-9]*)/)||src.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/)){return true;}
